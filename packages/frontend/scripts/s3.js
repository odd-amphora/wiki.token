...
if (!BUCKETNAME) {
  console.log("☢️   Enter a bucket name in packages/frontend/scripts/s3.js ");
  process.exit(1);
}
...
try {
  ...
  console.log(e);
  console.log(
    '☢️   Create an aws.json credentials file in packages/frontend/ like { "accessKeyId": "xxx", "secretAccessKey": "xxx", "region": "xxx" } ',
  );
  process.exit(1);
}
